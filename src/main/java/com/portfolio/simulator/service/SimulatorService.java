...
public class SimulatorService {
    ...
    private static Map<Integer, double[]> buildDefaultData() {
        ...
        data.put(1926, new double[]{ -0.0112, 0.1161, 0.0839, 0.0327, 0.0538, 0.0839, 0.0839, 0.0839, 0.0839 });
        data.put(1927, new double[]{ -0.0226, 0.3748, 0.3348, 0.0312, 0.0452, 0.3348, 0.3348, 0.3348, 0.3348 });
        data.put(1928, new double[]{ -0.0116, 0.4361, 0.3839, 0.0356, 0.0092, 0.3839, 0.3839, 0.3839, 0.3839 });
        data.put(1929, new double[]{ 0.0058, -0.0841, -0.1519, 0.0475, 0.0601, -0.1519, -0.1519, -0.1519, -0.1519 });
